  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="p-4 px-6  mt-8 rounded-sm flex items-center justify-between  w-11/12 md:w-[80%] bg-gray-500">
          <p className="font-bold text-xl text-primary w-[30%] ">Course Name</p>
          <p className="w-4/12 text-xl font-bold text-primary">Teacher Name</p>
