...
const Fee = () => {
  return (
    <div>
        ...
        <div className='flex items-center justify-between w-11/12 p-3 px-6 mt-8 bg-gray-500 rounded-sm md:w-8/12'>
           <p className='text-xl font-bold text-white'>Teacher Name</p>
            <p className='text-xl font-bold text-white '>Course Name</p>
            <p className='text-xl font-bold text-white '>No of Lectures</p>
